...
public static class PostgresTestContainer
{
    ...
    /// 13.4.5's <c>PostgresContainerImageTags</c> default (<c>docker.io/library/postgres:18.3</c>) — so
    ...
    public static PostgreSqlContainer Create() => new PostgreSqlBuilder().WithImage(Image).Build();
}
